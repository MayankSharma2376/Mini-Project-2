    ...
    return (
      <div className="bg-white rounded-lg shadow-sm p-6">
        ...
        <div className="text-center py-8">
          ...
          <h4 className="text-md font-medium text-gray-900 mb-2">Select an Opportunity</h4>
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-gray-900 flex items-center">
            <Users className="h-5 w-5 mr-2 text-blue-600" />
            Recommended Volunteers
            <span className="ml-2 text-sm text-gray-500">for {opportunityTitle}</span>
          </h3>
          <button
        ...
        <div className="text-center py-8">
          ...
          <h4 className="text-md font-medium text-gray-900 mb-2">No Matches Found</h4>
          <p className="text-gray-500">
            ...
            <div className="flex items-start justify-between mb-3">
              ...
              <div className="flex space-x-2">
                ...
                <button
                  ...
                  className="p-2 text-blue-600 hover:text-blue-700 rounded-lg hover:bg-blue-50 disabled:opacity-50"
              ...
              <div className="mt-4 pt-4 border-t border-gray-200">
                ...
                {match.volunteer.bio && (
                  <div className="mb-4">
                    ...
                    <p className="text-sm text-gray-600 mt-1">{match.volunteer.bio}</p>
                  </div>
                )}
